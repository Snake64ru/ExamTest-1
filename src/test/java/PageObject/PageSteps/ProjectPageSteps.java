...
public class ProjectPageSteps {
    ...
    public static void getTasksCount() {
        ...
        int tcount = Integer.parseInt(count.split(" ")[2]);
        Allure.addAttachment("Количество задач", String.valueOf(tcount));
    }
    ...
    @Step("Создание бага")
    public static void testNewBug() throws InterruptedException {
        createLink.click();
        typeTask.click();
    ...
    public static void myTask() throws InterruptedException {
        myTask.click();
        statusInWork.click();
        sleep(1000);
